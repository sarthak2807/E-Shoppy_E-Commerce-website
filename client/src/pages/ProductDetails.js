...
const ProductDetails = () => {
    ...
    const getProduct =async() =>{
        try {
            const {data}=await axios(`/api/v1/product/get-product/${params.slug}`)
  ...
  return (
    <Layout>
        <div className="row container product-details">
            ...
            <img src={`/api/v1/product/product-photo/${product._id}`} className="card-img-top"  alt={product._name} height="300" width="350px"/>
            </div>
        ...
        <hr />
        <div className="row container similiar-products">
